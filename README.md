...
# PULSAR-VOIP
**Voice over IP integration for Pulsar Framework**
...
VoIP integration layer for Pulsar Framework handling proximity voice, radio channels, and phone call audio routing between players.
